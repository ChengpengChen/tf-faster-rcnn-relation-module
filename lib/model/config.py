...
# Number of top scoring boxes to keep after applying NMS to RPN proposals
__C.TEST.RPN_POST_NMS_TOP_N = 256
...
#
# Relation module options
#
# to insert relation module in the fc layer
__C.RM = edict()
__C.RM.ENABLE_INSTANCE = False
__C.RM.ENABLE_DUP_REMV = False

__C.RM.FEA_DIM_INSTANCE = 1024
__C.RM.NUM_RELATION = 16
__C.RM.KEY_FEA_DIM = 64
__C.RM.POS_FEA_DIM = 64
# for the duplicate removal stop
__C.RM.FEA_DIM_DUP_REMV = 64
__C.RM.BBOX_NUM_DUP_REMV = 100
