...
STANDARD_COLORS = ['Wheat', 'Red', 'Yellow', 'Blue',
    'Cyan',
    'DarkOrange',
    'DeepPink',
    'ForestGreen',  'LightGoldenRodYellow',
    'Linen',  'OldLace', 'Olive', 'Orange', 'OrangeRed',
    'Orchid', 'PaleGoldenRod', 'PaleGreen', 'PaleTurquoise', 'PaleVioletRed',
    'PapayaWhip', 'PeachPuff', 'Peru', 'Pink', 'Plum', 'PowderBlue', 'Purple',
    'Red', 'RosyBrown', 'RoyalBlue', 'SaddleBrown', 'Green', 'SandyBrown',
    'SeaGreen', 'SeaShell', 'Sienna', 'Silver', 'SkyBlue', 'SlateBlue',
    'SlateGray', 'SlateGrey', 'SpringGreen', 'SteelBlue', 'GreenYellow',
...
def demo(sess, net, image_name):
    ...
    CONF_THRESH = 0.8
    NMS_THRESH = 0.3
    vis_detections_one_img(im, image_name, boxes, scores)
    ...
    #     keep = nms(dets, NMS_THRESH)
    #     dets = dets[keep, :]
    #     vis_detections_col(im, cls, dets, col_ind=cls_ind, thresh=CONF_THRESH)
...
if __name__ == '__main__':
    ...
    tfmodel = os.path.join('output', demonet, DATASETS[dataset][0], 'default',
                              NETS[demonet][0])
    tfmodel = '/media/chencp/Data/expm/tf-faster-rcnn-multi-img/output/vgg16/' \
              'voc_2007_trainval/default/vgg16_faster_rcnn_iter_70000.ckpt'
